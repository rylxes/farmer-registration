...
package com.register.farmerregistration.util.lambdaworks.crypto;

import java.io.UnsupportedEncodingException;
import java.security.GeneralSecurityException;
import java.security.SecureRandom;

import static com.register.farmerregistration.util.lambdaworks.codec.Base64.decode;
import static com.register.farmerregistration.util.lambdaworks.codec.Base64.encode;
...
public class SCryptUtil {
    ...
    public static boolean check(String passwd, String hashed) {
        try {
            ...
            System.out.println(!parts[1].equals("s0"));
